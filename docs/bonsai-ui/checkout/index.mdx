...
You can obtain `order` information after a successful checkout, or an `error` in case of a failure, through _callbacks_.
We will explain how to do this in the following sections.
...
<body>
  <!-- Bonsai Checkout JS -->
  <script data-bonsai-partner-id="YOUR_API_KEY" src="TODO"></script>
</body>
```
