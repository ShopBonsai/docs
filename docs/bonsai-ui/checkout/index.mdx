...
type Config = {
  ...
  customOrderSuccessLink?: string;
  /* A custom link text displayed on the order success page. If not provided, the link will not be displayed. */
  customOrderSuccessLinkText?: string;
